...
from aloha.constants import FPS, FOLLOWER_GRIPPER_JOINT_OPEN, DATA_DIR
...
wandb.login(key="1ef09f362c396a3e5418894d2b0e2c0c720a90dc")
                        ...
                        if vq:
                            if rollout_id == 0:
                                for _ in range(10):
                                    ...
                                    print(
                                        torch.nonzero(vq_sample[0])[:, 1].cpu().numpy()
                                    )
